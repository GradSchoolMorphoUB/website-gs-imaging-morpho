...
## Git
Although [Git](https://git-scm.com/downloads) will not be used by itself, it will be necessary to install some R packages below, or to download ("*clone*") Git repositories online.
